        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAddressSnapshot_AddressLine1 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DeliveryAddressSnapshot_AddressLine2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DeliveryAddressSnapshot_Area = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DeliveryAddressSnapshot_City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DeliveryAddressSnapshot_Landmark = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    DeliveryAddressSnapshot_Latitude = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: true),
                    DeliveryAddressSnapshot_Longitude = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: true),
                    DeliveryAddressSnapshot_MobileNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DeliveryAddressSnapshot_PostalCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DeliveryAddressSnapshot_RecipientName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DeliveryAddressSnapshot_State = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DeliveryFeeAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DeliveryFeeCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityValue = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryNote = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ShopId_DisplayOrder",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ShopId_CategoryId_DisplayOrder",
                table: "Products",
                columns: new[] { "ShopId", "CategoryId", "DisplayOrder" });
