...
/// <summary>
/// Validator for the <see cref="CreateAddressRequest"/> class.
/// </summary>
public sealed class CreateAddressRequestValidator
    : AbstractValidator<CreateAddressRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CreateAddressRequestValidator"/> class.
    /// </summary>
